...
namespace IConnect_Training_.Net_Core_project.Controllers
{
    public class MedicalHistoriesController : Controller
    {
        ...
        public MedicalHistoriesController(ClinicManagementSystemContext context)
        {
            _context = context;
        }
        ...
        {
            var clinicManagementSystemContext = _context.MedicalHistories.Include(m => m.Patient);
        ...
        public async Task<IActionResult> Create([Bind("Id,Description,PatientId")] MedicalHistory medicalHistory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("Id,Description,PatientId")] MedicalHistory medicalHistory)
        {
